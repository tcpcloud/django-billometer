...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ResourceType.flavor'
        db.delete_column('billometer_resourcetype', 'flavor')

        # Adding field 'ResourceType.extra'
        db.add_column('billometer_resourcetype', 'extra',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


        # Changing field 'ResourceType.default_price'
        db.alter_column('billometer_resourcetype', 'default_price', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=6))

    def backwards(self, orm):
        # Adding field 'ResourceType.flavor'
        db.add_column('billometer_resourcetype', 'flavor',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ResourceType.extra'
        db.delete_column('billometer_resourcetype', 'extra')


        # Changing field 'ResourceType.default_price'
        db.alter_column('billometer_resourcetype', 'default_price', self.gf('django.db.models.fields.DecimalField')(max_digits=18, decimal_places=3))
