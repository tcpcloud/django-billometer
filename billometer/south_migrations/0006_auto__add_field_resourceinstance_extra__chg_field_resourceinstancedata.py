...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceInstance.extra'
        db.add_column('billometer_resourceinstance', 'extra',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


        # Changing field 'ResourceInstanceData.start'
        db.alter_column('billometer_resourceinstancedata', 'start', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))

    def backwards(self, orm):
        # Deleting field 'ResourceInstance.extra'
        db.delete_column('billometer_resourceinstance', 'extra')


        # Changing field 'ResourceInstanceData.start'
        db.alter_column('billometer_resourceinstancedata', 'start', self.gf('django.db.models.fields.DateField')(null=True))
