...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceInstance.is_active'
        db.add_column('billometer_resourceinstance', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceInstance.is_active'
        db.delete_column('billometer_resourceinstance', 'is_active')
